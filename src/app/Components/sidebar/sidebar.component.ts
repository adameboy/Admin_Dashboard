...
@Component({
  ...
  <ul class="space-y-2 font-medium">
    <li>
       <a routerLink="/home"  routerLinkActive="bg-gray-700"  class="flex items-center p-2 text-white rounded-lg dark:text-white hover:text-gray-700 hover:bg-gray-100  dark:hover:bg-gray-700 group">
    ...
    <li>
       <a routerLink="/users" routerLinkActive="bg-gray-700" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-100 hover:text-gray-700 dark:hover:bg-gray-700 group">
